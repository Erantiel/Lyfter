...
INSERT INTO lyfter_car_rental.users(name, email, username, password, birthday) --a. Un script que agregue un usuario nuevo
    VALUES('Michael Mendoza', 'mmendoza@lyfter.com', 'mmendoz98', 'Hjkm1287Nm/','4/25/1995');
----------
...
UPDATE lyfter_car_rental.vehicles SET --d. Un script que cambie el estado de un automovil
    ...
    WHERE id = 11;
----------
INSERT INTO lyfter_car_rental.users_vehicles(user_id, vehicle_id, status) --e. Un script que genere un alquiler nuevo con los datos de un usuario y un automovil
    VALUES(1,1,'rented');
UPDATE lyfter_car_rental.vehicles SET
    status = 'rented'
    WHERE id = 1;
INSERT INTO lyfter_car_rental.users_vehicles(user_id, vehicle_id, status) -- More data for request 'g'
    VALUES(1,3,'rented');
UPDATE lyfter_car_rental.vehicles SET
    status = 'rented'
    WHERE id = 3;
