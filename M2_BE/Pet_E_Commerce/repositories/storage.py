...
class Storage(Base):
    ...
    storage_status_id: Mapped[int] = mapped_column(ForeignKey("storage_status.id"))

    product_relation = relationship("Product", back_populates="storage_relation")
    storage_status_relation = relationship("StorageStatus", back_populates="storage_relation")
