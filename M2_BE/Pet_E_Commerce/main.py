...
from validation import validate_all_data, validate_one_field
    ...
    def post(self):
        try:
            ...
            if data is None:
                ...
                validate_all_data(data, "username", "password")
...
class UserView(MethodView):
    ...
    def get(self):
        try:
            ...
            validate_one_field(data, "id", "name")
...
app.add_url_rule("/user/all", methods=["GET", "POST", "PUT", "DELETE"], view_func=user_view)
