...
--INSERT of Product
INSERT INTO e_commerce.product (sku, name, price, currency, description, category_id, brand_id) VALUES ('043310980', 'Dog Dry Food', 20, 'Dollar', '1KG', 1, 3);
INSERT INTO e_commerce.product (sku, name, price, currency, description, category_id, brand_id) VALUES ('031100490', 'Dog Treats', 7, 'Dollar', '150G', 1, 1);
INSERT INTO e_commerce.product (sku, name, price, currency, description, category_id, brand_id) VALUES ('081006052', 'Cat Dry Food', 18, 'Dollar', '1KG', 1, 2);
INSERT INTO e_commerce.product (sku, name, price, currency, description, category_id, brand_id) VALUES ('042104469', 'Cat Treats', 7, 'Dollar', '150G', 1, 2);
INSERT INTO e_commerce.product (sku, name, price, currency, description, category_id, brand_id) VALUES ('092900956', 'Dog Harness', 15, 'Dollar', 'Adjustable', 2, 4);
INSERT INTO e_commerce.product (sku, name, price, currency, description, category_id, brand_id) VALUES ('081501175', 'Cat Harness', 12, 'Dollar', 'Adjustable', 2, 5);
INSERT INTO e_commerce.product (sku, name, price, currency, description, category_id, brand_id) VALUES ('031275998', 'Bone Plush', 15, 'Dollar', 'Wool Made', 3, 1);
INSERT INTO e_commerce.product (sku, name, price, currency, description, category_id, brand_id) VALUES ('061192753', 'Fish Plush', 10, 'Dollar', 'Wool Made', 3, 3);
INSERT INTO e_commerce.product (sku, name, price, currency, description, category_id, brand_id) VALUES ('051408923', 'Bowl', 20, 'Dollar', 'Stainless Steel', 4, 4);
INSERT INTO e_commerce.product (sku, name, price, currency, description, category_id, brand_id) VALUES ('111906161', 'Scratching Post', 35, 'Dollar', 'Non Toxic Sisal', 4, 5);
--INSERT of Store
...
--INSERT of Bill
INSERT INTO e_commerce.bill (user_id, total_amount, currency, payment_method_id) VALUES (2, 67, 'Dollar', 2);
INSERT INTO e_commerce.bill (user_id, total_amount, currency, payment_method_id) VALUES (2, 85, 'Dollar', 2);
INSERT INTO e_commerce.bill (user_id, total_amount, currency, payment_method_id) VALUES (7, 100, 'Dollar', 2);
--INSERT of Product_Bill
INSERT INTO e_commerce.product_bill (product_id, bill_id, product_amount, total_amount, currency) VALUES (1, 1, 3, 60, 'Dollar');
INSERT INTO e_commerce.product_bill (product_id, bill_id, product_amount, total_amount, currency) VALUES (4, 1, 1, 7, 'Dollar');
INSERT INTO e_commerce.product_bill (product_id, bill_id, product_amount, total_amount, currency) VALUES (5, 2, 1, 15, 'Dollar');
INSERT INTO e_commerce.product_bill (product_id, bill_id, product_amount, total_amount, currency) VALUES (10, 2, 2, 70, 'Dollar');
INSERT INTO e_commerce.product_bill (product_id, bill_id, product_amount, total_amount, currency) VALUES (9, 3, 2, 40, 'Dollar');
INSERT INTO e_commerce.product_bill (product_id, bill_id, product_amount, total_amount, currency) VALUES (7, 3, 4, 60, 'Dollar');
--INSERT of Shopping Cart
INSERT INTO e_commerce.shopping_cart (user_id) VALUES (7);
INSERT INTO e_commerce.shopping_cart (user_id) VALUES (8);
--INSERT of Product Shopping Cart
INSERT INTO e_commerce.product_shopping_cart (shopping_cart_id, product_id, product_amount) VALUES (1, 1, 10);
INSERT INTO e_commerce.product_shopping_cart (shopping_cart_id, product_id, product_amount) VALUES (2, 10, 1);